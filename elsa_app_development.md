...
# Shutdown("state":False) or power-on("state":True) speakers by controlling the amplifier
...
panic_button_topic = "m5stickC.panic_button"
...
def panic_button_callback(msg, meta):
    try:
    	...
    	log.debug("Error occured: {}".format(e))
...
if __name__ == "__main__":
    ...
    try:
        ...
        sub = Subscriber(conn_params=conn_params,
                        topic=panic_button_topic,
                        on_message=panic_button_callback)
